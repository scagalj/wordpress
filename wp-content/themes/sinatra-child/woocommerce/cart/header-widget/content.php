			...
			<div class="si-cart-item">
				...
				<div class="si-cart-item-details">
					...
					<?php if ( $cart_item['quantity'] > 1 ) { ?>
						...
						<span class="si-cart-item-price"><?php echo number_format(calculatePrice($product_id, $imageSize, $frameType, $setType, $price) , 2, ',', '.') . ' ' . get_woocommerce_currency_symbol();// phpcs:ignore ?></span>
					</div>
				</div>
